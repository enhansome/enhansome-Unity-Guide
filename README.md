...
[VKD3D-Proton](https://github.com/HansKristian-Work/vkd3d-proton) ⭐ 2,933 | 🐛 343 | 🌐 C | 📅 2026-08-28 is a fork of VKD3D, which aims to implement the full Direct3D 12 API on top of Vulkan.
...
[Meshroom](https://github.com/alicevision/meshroom) ⭐ 12,931 | 🐛 516 | 🌐 Python | 📅 2026-08-28 is a free, open-source 3D Reconstruction Software based on the AliceVision framework.
