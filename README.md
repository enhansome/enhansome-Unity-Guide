...
[HLSL to SPIR-V Feature Mapping Manual](https://github.com/microsoft/DirectXShaderCompiler/blob/master/docs/SPIR-V.rst) ⭐ 3,644 | 🐛 771 | 🌐 C++ | 📅 2026-09-04
...
[Lua Language Server](https://github.com/sumneko/lua-language-server) ⭐ 4,359 | 🐛 707 | 🌐 Lua | 📅 2026-09-04 is an extension for VSCode that provides support for the Lua Language Server.
