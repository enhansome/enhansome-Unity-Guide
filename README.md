...
[Vulkan Documentation](https://github.com/KhronosGroup/Vulkan-Docs) ⭐ 3,340 | 🐛 389 | 🌐 JavaScript | 📅 2026-09-21
...
[Vulkan Samples](https://github.com/KhronosGroup/Vulkan-Samples) ⭐ 5,379 | 🐛 58 | 🌐 C++ | 📅 2026-09-21
...
[DXVK](https://github.com/doitsujin/dxvk) ⭐ 18,122 | 🐛 258 | 🌐 C++ | 📅 2026-09-19 is a Vulkan-based translation layer for Direct3D 9/10/11 which allows running 3D applications on Linux using Wine.
...
[VKD3D-Proton](https://github.com/HansKristian-Work/vkd3d-proton) ⭐ 2,961 | 🐛 310 | 🌐 C | 📅 2026-09-21 is a fork of VKD3D, which aims to implement the full Direct3D 12 API on top of Vulkan.

[ImGui](https://github.com/ocornut/imgui) ⭐ 76,310 | 🐛 1,226 | 🌐 C++ | 📅 2026-09-21 is a bloat-free graphical user interface library for C++. It outputs optimized vertex buffers that you can render anytime in your 3D-pipeline enabled application. It is fast, portable, renderer agnostic and self-contained (no external dependencies).
