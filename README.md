...
[HLSL to SPIR-V Feature Mapping Manual](https://github.com/microsoft/DirectXShaderCompiler/blob/master/docs/SPIR-V.rst) ⭐ 3,646 | 🐛 758 | 🌐 C++ | 📅 2026-09-11
...
[Vulkan Samples](https://github.com/KhronosGroup/Vulkan-Samples) ⭐ 5,365 | 🐛 66 | 🌐 C++ | 📅 2026-09-10
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,459 | 🐛 1,116 | 🌐 CMake | 📅 2026-09-11 is a C++ Library Manager for Windows, Linux, and MacOS.
