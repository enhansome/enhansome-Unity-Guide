...
[VKD3D-Proton](https://github.com/HansKristian-Work/vkd3d-proton) ⭐ 2,951 | 🐛 324 | 🌐 C | 📅 2026-09-14 is a fork of VKD3D, which aims to implement the full Direct3D 12 API on top of Vulkan.
...
[Meshroom](https://github.com/alicevision/meshroom) ⭐ 12,959 | 🐛 520 | 🌐 Python | 📅 2026-09-14 is a free, open-source 3D Reconstruction Software based on the AliceVision framework.
...
[Azure SDK for C++](https://github.com/Azure/azure-sdk-for-cpp) ⭐ 205 | 🐛 177 | 🌐 C++ | 📅 2026-09-14
...
[Apache APISIX](https://github.com/apache/apisix) ⭐ 17,120 | 🐛 241 | 🌐 Lua | 📅 2026-09-14 is a dynamic, real-time, high-performance API gateway, based on the Nginx library and etcd.
