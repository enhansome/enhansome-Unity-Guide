...
[Vulkan Samples](https://github.com/KhronosGroup/Vulkan-Samples) ⭐ 5,372 | 🐛 69 | 🌐 C++ | 📅 2026-09-10
...
[VKD3D-Proton](https://github.com/HansKristian-Work/vkd3d-proton) ⭐ 2,954 | 🐛 321 | 🌐 C | 📅 2026-09-15 is a fork of VKD3D, which aims to implement the full Direct3D 12 API on top of Vulkan.

[ImGui](https://github.com/ocornut/imgui) ⭐ 76,199 | 🐛 1,231 | 🌐 C++ | 📅 2026-09-15 is a bloat-free graphical user interface library for C++. It outputs optimized vertex buffers that you can render anytime in your 3D-pipeline enabled application. It is fast, portable, renderer agnostic and self-contained (no external dependencies).
