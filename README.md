...
[AutoRest](https://github.com/Azure/autorest) ⭐ 4,799 | 🐛 22 | 🌐 TypeSpec | 📅 2026-08-12 is a tool generates client libraries for accessing RESTful web services using the [OpenAPI Specification](https://github.com/OAI/OpenAPI-Specification) ⭐ 31,159 | 🐛 121 | 🌐 Markdown | 📅 2026-08-13 format. It Supports C#, PowerShell, Go, Java, Node.js, TypeScript, Python, Ruby.
